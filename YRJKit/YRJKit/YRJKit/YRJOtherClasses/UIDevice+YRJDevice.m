...
@implementation UIDevice (YRJDevice)
...
- (BOOL)isJailbroken {
    ...
    NSString *path = [NSString stringWithFormat:@"/private/%@", [NSString yrj_stringWithUUID]];
