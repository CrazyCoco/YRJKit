//
//  NSAttributedString+YRJAttributedString.m
//  YRJKit
//
...
@implementation NSAttributedString (YRJAttributedString)

- (CGFloat)yrj_attributedStringHeightWithContainWidth:(CGFloat)width {
...
#pragma mark - 修改字符串颜色
+ (NSAttributedString *)yrj_attributeStringWithString:(NSString *)string
                                               color:(UIColor *)color
                                               range:(NSRange)range {
...
+ (NSAttributedString *)yrj_attributeStringWithAttributedString:(NSAttributedString *)attributedString
                                                         color:(UIColor *)color
                                                         range:(NSRange)range {
...
+ (NSAttributedString *)yrj_attributeStringWithPrefixString:(NSString *)prefixString
                                                prefixFont:(UIFont *)prefixFont
                                              suffixString:(NSString *)suffixString
                                                suffixFont:(UIFont *)suffixFont {
    
    return [NSAttributedString yrj_attributeStringWithPrefixString:prefixString
