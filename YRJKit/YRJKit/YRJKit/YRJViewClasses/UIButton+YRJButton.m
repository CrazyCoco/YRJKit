...
@implementation UIButton (YRJButton)
...
{
    objc_setAssociatedObject(self, @selector(yrj_addActionHandler:), touchHandler, OBJC_ASSOCIATION_COPY_NONATOMIC);
...
{
    TouchedButtonBlock block = objc_getAssociatedObject(self, @selector(yrj_addActionHandler:));
    if (block)
    {
        block();
    }
...
//
//- (NSTimeInterval)yrj_acceptEventTime {
//    return  [objc_getAssociatedObject(self, UIControl_acceptEventTime) doubleValue];
//}
//
//- (void)setYrj_acceptEventTime:(NSTimeInterval)yrj_acceptEventTime {
//    objc_setAssociatedObject(self, UIControl_acceptEventTime, @(yrj_acceptEventTime), OBJC_ASSOCIATION_RETAIN_NONATOMIC);
//}
//
//// 在load时执行hook
//+ (void)load {
...
//        SEL afterSelector = @selector(yrj_sendAction:to:forEvent:);
//
...
//
//
//    if ([NSDate date].timeIntervalSince1970 - self.yrj_acceptEventTime < self.yrj_acceptEventInterval) {
//        return;
//    }
//
//    if (self.yrj_acceptEventInterval > 0) {
//        self.yrj_acceptEventTime = [NSDate date].timeIntervalSince1970;
//    }
//
