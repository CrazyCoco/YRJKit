...
@implementation UIColor (YRJColor)
...
+ (instancetype)yrj_colorWithHex:(uint32_t)hex {
    ...
    return [self yrj_colorWithRed:r green:g blue:b];
}

+ (instancetype)yrj_randomColor {
    return [UIColor yrj_colorWithRed:arc4random_uniform(256) green:arc4random_uniform(256) blue:arc4random_uniform(256)];
}
...
+ (UIColor*)yrj_gradientFromColor:(UIColor*)c1 toColor:(UIColor*)c2 withHeight:(CGFloat)height
{
